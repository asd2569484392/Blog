                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div class="table-toolbar">
                                      <div class="btn-group">
                                         <a href="<%=path%>/Back/Editor.jsp"><button class="btn btn-success">写博客 <i class="icon-plus icon-white"></i></button></a>
                                      </div>
                            		...
                            		<%for(Drafts d:draftsList){ %>
                                            <tr class="odd gradeX">
                                               ...
                                               <td><%=d.getDraft_type() %></td>
                                                <td><a href="<%=path %>/back/release.do?id=<%=d.getId()%>&type=<%=d.getDraft_type()%>" class="btn"><i class="icon-eye-open"></i>发布</a></td>
