...
public class BlogServiceImpl implements BlogService {
	 ...
	 * @param blog_content
	 */
	public void insertBlog(String blog_title,String blog_intro,String blog_content, String blog_keyword, String blog_photoURL) {		
			blogDAO.insertNewBlog(new Blog(0, blog_title, blog_intro,
					blog_content, "杨超杰", TimeUtil.getMM_yyyy(), blog_photoURL,
					blog_keyword));
	}
