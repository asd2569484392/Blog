...
public class ArticleServiceImpl implements ArticleService {
	...
	@Override
	public void insertArticle(String article_title, String article_intro,String article_content,
			String article_PhotoURL,String article_keyword) {
		articleDAO.insertNewArticle(new Article(0, article_title,
				article_intro, article_content, "杨超杰", TimeUtil
						.getMM_yyyy(), article_PhotoURL, article_keyword));
